...
//	  [key: string]: MessageData | compiled message | string;
//	}
type MessageData map[string]any // MessageData | *CompiledMessage | string
...
//	  addMessages(data: MessageData | compiled message, locale?: string, keypath?: string[])
...
// addMessages(
//
//	data: MessageData | compiled message,
//	locale?: string,
//	keypath?: string[]
//
//	) {
...
func (m *Messages) Get(key any, props map[string]any, locale *string) (any, error) {
	...
	if msg := m.get(m._data[lc], key); msg != nil {
		if message, ok := msg.(*CompiledMessage); ok {
			return message.Format(props)
		}
		return msg, nil
	}
...
// function _get(
//
//	obj: MessageData | compiled message | string,
//	key: string | string[]
//
//	) {
//	  if (!obj) return null;
//	  let res: MessageData | compiled message | string = obj;
